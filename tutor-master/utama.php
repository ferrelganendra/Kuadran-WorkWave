            ...
            <div class="col-lg-8">
                <div class="box h-100 p-4">
                    <div class="form-container mb-4">
                        <h4 class="mb-3">Advanced Job Search</h4>
